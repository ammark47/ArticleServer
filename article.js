...
function connect() {
    ...
    while(index < TeamList.length){
        do{
           ...
           setTimeout(function(){
                 connectStream(TeamList[index]); 
               }, (1000 * index));
            
            elapsedTime = Date.now() - currentTime;
            console.log("elapsed time: " + elapsedTime);
        }while(index < TeamList.length && elapsedTime > 1000)
    }
